...
├── podcast-backend/           # FastAPI Python backend
│   ├── app/
│   │   ├── api/               # API routes (podcast generation, voices, status)
│   │   ├── core/              # Config, settings, logging, error handling
│   │   ├── models/            # Pydantic data schemas
│   │   ├── services/          # Business logic:
│   │   │   ├── gemini_service.py        # Gemini LLM integration
│   │   │   ├── ollama_service.py        # Ollama local LLM integration
│   │   │   ├── voice_clone_service.py   # XTTS-v2 voice synthesis
│   │   │   ├── fish_audio_service.py    # Fish Audio TTS integration
│   │   │   ├── audio_pipeline_service.py# FFmpeg audio stitching & mixing
│   │   │   └── music_service.py         # Background music handling
│   │   └── assets/            # Audio assets (default voices, music)
│   ├── tests/                 # Unit and pipeline tests
│   ├── requirements.txt       # Python dependencies
│   └── .env.example           # Environment template
│
├── podcast-frontend/          # Vite + React + TypeScript frontend
